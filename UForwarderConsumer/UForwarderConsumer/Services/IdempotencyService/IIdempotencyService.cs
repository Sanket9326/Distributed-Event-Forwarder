namespace UForwarderConsumer.Services.IdempotencyService
{
    public interface IIdempotencyService
    {
        ...
        Task<bool> IsMessageAvailableToProcess(string messageId);
        ...
        Task<bool> MarkMessageAsProcessing(string messageId);
        ...
        /// <param name="messageId">Unique identifier of the message.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        Task<bool> MarkMessageAsCompleted(string messageId);
        ...
        /// <param name="messageId">Unique identifier of the message.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
        Task<bool> DeletedMessage(string messageId);
    }
}
